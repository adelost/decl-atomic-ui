<script lang="ts">
  import type { StatCardMolecule } from '@daui/core';
  import Icon from '../atoms/Icon.svelte';

  let { title, value, change, icon }: StatCardMolecule = $props();

  // Handle reactive value
  let displayValue = $derived(typeof value === 'function' ? value() : value);
